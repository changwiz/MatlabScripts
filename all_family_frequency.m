function all_family_frequency()

file_path = './all_frequency.txt';
...
set(get(gca,'XLabel'),'string','Time (seconds)','FontSize',25,'FontWeight','b');
set(get(gca,'YLabel'),'string','Number of DDoS Attacks','FontSize',25,'FontWeight','b');
...
grid on;
% saveas(hFig,'./daily_freq.eps','epsc');
